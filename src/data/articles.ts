...
export const articlesData: Article[] = [
  {
    ...
    content: `
      ...
      <h3>1. Enhanced Long-Term Returns</h3>
      ...
      <h3>2. Superior Risk Management</h3>
      ...
      <h3>3. Aligning Investments with Personal Values</h3>
      ...
      <h2>How to Build a Sustainable Portfolio</h2>
